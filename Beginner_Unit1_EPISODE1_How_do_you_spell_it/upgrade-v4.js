...
const WOW_V4_HELPERS={
  1:{title:"Лёгкая подсказка",html:"Сначала определи ситуацию: classroom language, знакомство, отель или ресторан. Смысл ситуации поможет выбрать точную фразу."},
  2:{title:"Простое правило",html:"Найди подлежащее в предложении и проверь, какая форма <b>verb be</b> с ним сочетается. Затем посмотри, утверждение это или вопрос."},
  3:{title:"Лёгкая подсказка",html:"Слушай буквы по одной и мысленно соединяй их в слово. Не спеши выбирать вариант после первой буквы."},
  4:{title:"Лёгкая подсказка",html:"Определи цель реплики: check-in в отеле или booking в ресторане. Выбирай ответ, который естественно продолжает эту ситуацию."}
};
const WOW_V4_TRANSCRIPT_SPEAKERS={"1": ["Receptionist", "Maya"], "2": ["Host", "Alex"]};
