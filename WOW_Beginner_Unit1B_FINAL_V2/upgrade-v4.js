...
const WOW_V4_HELPERS={
  1:{title:"Лёгкая подсказка",html:"Определи, что проверяется: country, place или ключевая фраза Lesson 1B. Сначала пойми смысл, потом выбирай вариант."},
  2:{title:"Простое правило",html:"Найди, о ком или о чём говорится: <b>he / she / it</b>. После этого проверь форму <b>verb be</b> и тип предложения."},
  3:{title:"Лёгкая подсказка",html:"Прослушай слово полностью и сосредоточься на целевом звуке. Сравни звучание, а не написание слова."},
  4:{title:"Лёгкая подсказка",html:"Смотри на предыдущую реплику и выбери естественное продолжение разговора о человеке, стране или месте."}
};
const WOW_V4_TRANSCRIPT_SPEAKERS={};
const WOW_V4_VOICE_MAP={"Amy": "Mia", "Brian": "Ben"};
