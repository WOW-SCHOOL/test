...
const LABELS={phrases:'Countries & Phrases',grammar:'Grammar',numbers:'Sound Detective',days:'Where from?',reading:'Reading',pron:'Grammar Sort',listening:'Listening'};
const STORAGE_KEY='wow_beginner_1b_v1';
...
const data={
 ...
 grammar:[
  ...
  {q:'Ben is from England. He ___ from France.',a:'isn’t',o:['is','isn’t','am']},
 ...
 pron:[
  {w:'He’s from Germany.',a:'AFFIRMATIVE'},
  {w:'She’s from Japan.',a:'AFFIRMATIVE'},
  {w:'It’s in Spain.',a:'AFFIRMATIVE'},
  {w:'He isn’t from Turkey.',a:'NEGATIVE'},
  {w:'She isn’t from Mexico.',a:'NEGATIVE'},
  {w:'It isn’t in France.',a:'NEGATIVE'},
  {w:'Is he from Brazil?',a:'QUESTION'},
  {w:'Is she from Poland?',a:'QUESTION'},
  {w:'Is it in Italy?',a:'QUESTION'},
  {w:'Is it good?',a:'QUESTION'}
 ],
 listening:{
  scripts:[
   {id:1,lines:[
...
function renderPhraseVisual(item){const cat=PHRASE_CATEGORIES[item.q]||'Lesson 1B';return `<div class="sceneFrame phrasePanel"><img class="sceneImg" src="assets/images/world-music-countries.png" alt="World music and countries"><div class="visualBadge">${esc(cat)}</div><div class="speech modern">${esc(item.q)}</div></div>`}
...
function renderSoundVisual(){return `<div class="sceneFrame soundPanel"><img class="sceneImg contain padded" src="assets/images/sound-detective.png" alt="Sound listening"><div class="visualBadge">Listen first</div><div class="floatingCard">4 target sounds · one answer</div></div>`}
function renderContextVisual(){return `<div class="sceneFrame contextPanel"><img class="sceneImg contain padded" src="assets/images/dialogue-context.png" alt="Conversation about countries"><div class="visualBadge">Real-life English</div><div class="floatingCard">Choose the natural reply</div></div>`}
