...
const WOW_V4_HELPERS={
  1:{title:"Лёгкая подсказка",html:"Сначала реши, что дано на экране: country или nationality. Затем ищи соответствующую пару."},
  2:{title:"Простое правило",html:"Найди подлежащее <b>we / you / they</b> и проверь форму <b>verb be</b>. В отрицании и вопросе следи за порядком слов."},
  3:{title:"Лёгкая подсказка",html:"В аудио прозвучит страна. Сначала назови её про себя, а затем выбери правильную nationality form."},
  4:{title:"Лёгкая подсказка",html:"Определи контекст: знакомство, holiday или business. Нужная реплика должна естественно продолжать мини-диалог."}
};
const WOW_V4_TRANSCRIPT_SPEAKERS={"1": ["Elena", "David"], "2": ["Sofia", "Canadian guest"]};
